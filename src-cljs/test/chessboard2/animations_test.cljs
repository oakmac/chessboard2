...
(deftest calculate-animations-test
  (is (= (set (calculate-animations test1-posA test1-posB)) test1-anims))
  (is (= (set (calculate-animations test2-posA test2-posB)) test2-anims))
  (is (= (set (calculate-animations test3-posA test3-posB)) test3-anims))
  (is (= (set (calculate-animations test4-posA test4-posB)) test4-anims))
  (is (= (set (calculate-animations test5-posA test5-posB)) test5-anims))
  (is (= (set (calculate-animations test6-posA test6-posB)) test6-anims)))
